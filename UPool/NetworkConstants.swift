...
extension NetworkClient {
    ...
    // MARK: Poster Sizes
    struct PosterSizes {
        static let RowPoster = NetworkClient.sharedInstance().config.posterSizes[2]
        static let DetailPoster = NetworkClient.sharedInstance().config.posterSizes[4]
    }
}
